<template>
    <section>
        ...
        <div v-if="profileData" class="container">
            <h1 class="gamertag">
                <img :src="profileData.platformInfo.avatarUrl" alt="Gamertag ID Picture" class="patform-avatar" />
                {{profileData.platformInfo.platformUserId}}
            </h1>
            <div class="grid">
                <div>
                    <img :src="profileData.segments[1].metadata.imageUrl" alt="Gamertag Image">
                </div>
                <div>
                    <ul>
                        <li>
